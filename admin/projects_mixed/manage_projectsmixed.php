...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title"><u><b>Update Mixed Project Details</b> </u></h3>
	</div>
    <br>
    ...
    <div class="row">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="name" id="name" class="custom-select col-sm-3 rounded-0 select2 ml-2"  required>
						...
						<?php 
							$supplier_qry = $conn->query("SELECT * FROM `mixed_po_list` order by `pname` asc");
...
<!-- milestone view with fetch -->
    ...
    <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <tbody>
                        ...
                        FROM mixed_po_list where id = $name ");
...
if(FromDate > ToDate )
{
    ...
    $(function(){
        $('#project-form').submit(function(e){
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_mixedproject",
