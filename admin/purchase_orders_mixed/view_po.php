...
<div class="card card-outline card-info">
	<div class="card-header">
        ...
        <div class="card-tools">
		    ...
		    <a class="btn btn-sm btn-flat btn-primary" href="?page=purchase_orders_mixed/manage_mixedpo&id=<?php echo $id ?>">Edit</a>
             <?php endif; ?>
            ...
            <div class="col-md-12">
                <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <tbody>
                        <?php 
                        if(isset($id)):
                        $order_items_qry = $conn->query("SELECT * FROM `mixed_po_list` o inner join mixed_po_list i on o.id = i.id inner join mixed_project_list pl on o.id = name where o.`id` = '$id' ");
                        $sub_total = 0;
