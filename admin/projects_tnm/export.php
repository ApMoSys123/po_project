...
$query = "SELECT tpo.pname, tpo.client_id, tpl.department, tpl.department_head, tpl.teamlead, tpo.rm_apmosys, tpl.rm_client, tpl.rmclient_contact, tpl.rmclient_email, tpl.rmclient_location, tpl.tpdate_created, tpl.tpstartdate, tpl.tpenddate, tpl.tp_status, tpo.project_type, tpo.businesshead_name, tpo.bhead_approval, tpl.businesshead_comment, tpl.businessteam_comment, tpl.rmgteam_comment, tpl.otteam_comment, tpo.accountshead_name, tpl.director_comment, tpl.rmg_verified, tpl.dept_verified, tpo.ahead_approval, tpl.bill, tpo.po_no, tpo.date_created, tpo.date_updated, tpo.startdate, tpo.enddate, tpo.quantity, tpo.m_description, tpo.unit, tpo.m_status, tpo.m_startdate, tpo.m_enddate, tpl.m_otstatus, tpl.m_comments, tpo.notes2, tpo.notes3, tpo.notes4, tpo.notes5,  tpo.status, tpo.unit_price, tpo.tax_percentage, tpo.tax_amount, tpo.invoice, tpo.payment FROM tnm_po_list tpo inner join tnm_project_list tpl on tpo.id = tpl.name";
...
header('Content-Disposition: attachment; filename=tnm_projects.csv');
