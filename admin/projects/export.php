...
$query = "SELECT po.pname, po.client_id, pl.department, po.rm_apmosys, pl.rm_client, pl.department_head, pl.rmclient_contact, pl.rmclient_email, pl.rmclient_location, pl.pdate_created, pl.pstartdate, pl.penddate, pl.pstatus, po.project_type, po.businesshead_name, po.bhead_approval, pl.businesshead_comment, pl.businessteam_comment, pl.rmgteam_comment, pl.otteam_comment, po.accountshead_name, pl.director_comment, pl.rmg_verified, pl.dept_verified, po.ahead_approval, pl.bill, po.po_no, po.date_created, po.date_updated, po.startdate, po.enddate, pl.resourcecount, pl.resourcename, po.m_percent, po.unit, po.m_description, po.m_startdate, po.m_enddate, pl.m_otstatus, pl.m_comments, po.notes2, po.notes3, po.notes4, po.notes5,  po.status, po.monthly_comments, po.monthly_billable, po.unit_price, po.tax_percentage, po.tax_amount, po.consumed, po.balance, po.invoice, po.payment FROM po_list po inner join project_list pl on po.id = pl.name";
...
header('Content-Disposition: attachment; filename=fc_projects.csv');
