...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title"><u><b>Update Project Details</b></u> </h3>
	</div>
    <br>
    ...
    <?php if($_settings->userdata('type') ==  1): ?>
           ...
           <div  class="col-md-6 form-group">
            ...
            <div class="col-md-6 form-group">
                ...
                <select name="name" id="name" class="custom-select col-sm-3 rounded-0 select2 ml-2"  readonly>
						<option value="" disabled <?php echo !isset($name) ? "selected" :'' ?>></option>
						<?php 
							$supplier_qry = $conn->query("SELECT * FROM `po_list` order by `project_name` asc");
							while($row = $supplier_qry->fetch_assoc()):
            ...
            <div  class="col-md-6 form-group">
            <label for="pstartdate" class="control-label col-md-5 mt-2">Start Date : <span class="po_err_msg text-danger">*</span></label>
            <input type="text" name="pstartdate" id="date_picker1" class="ml-2" value="<?php echo isset($pstartdate) ? $pstartdate :"" ?>" readonly>
            </div>
            <div  class="col-md-6 form-group">
            <label for="penddate" class="control-label col-md-5">End Date : <span class="po_err_msg text-danger">*</span></label>
            <input type="text" name="penddate" id="date_picker2" class="ml-2" value="<?php echo isset($penddate) ? $penddate :"" ?>" readonly>
            </div>
            <?php endif; ?>
...
<table class="table table-striped table-bordered" id="item-list">
                    ...
                    <tbody>
                        ...
                        $order_items_qry = $conn->query("SELECT milestone_name,m_percent,m_description,m_startdate,m_enddate
                        FROM po_list where id = $name ");
                        
                        while($row = $order_items_qry->fetch_assoc()):
                             
                        ?>
                        <tr class="po-item" data-id="">
                            <td class="align-middle p-0 text-center"><?php echo $row['milestone_name'] ?></td>
                            ...
                            <?php if($_settings->userdata('type') ==  1): ?>
                					...
                					<option value="Not Started" <?php echo isset($m_otstatus) && $m_otstatus =="Not Started" ? "selected": "Not Started" ?>>Not Started</option>
                                        <option value="Pending" <?php echo isset($m_otstatus) && $m_otstatus =="Pending" ? "selected": "Pending" ?>>Pending</option>
                                        <option value="In Progress" <?php echo isset($m_otstatus) && $m_otstatus =="In Progress" ? "selected": "In Progress" ?>>In Progress</option>
                                        <option value="Completed" <?php echo isset($m_otstatus) && $m_otstatus =="Completed" ? "selected": "Completed" ?>>Completed</option>	
                                    ...
                                    <?php endif; ?>
                                    <?php if($_settings->userdata('type') ==  2): ?>
									<select name="m_otstatus" id="m_otstatus" class="text-center w-100 border-0" disabled>
                					<option value="Not Started" <?php echo isset($m_otstatus) && $m_otstatus =="Not Started" ? "selected": "Not Started" ?>>Not Started</option>
                                        <option value="Pending" <?php echo isset($m_otstatus) && $m_otstatus =="Pending" ? "selected": "Pending" ?>>Pending</option>
                                        <option value="In Progress" <?php echo isset($m_otstatus) && $m_otstatus =="In Progress" ? "selected": "In Progress" ?>>In Progress</option>
                                        <option value="Completed" <?php echo isset($m_otstatus) && $m_otstatus =="Completed" ? "selected": "Completed" ?>>Completed</option>	
