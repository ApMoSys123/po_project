...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title"><b><u>FC Project Details</b></u></h3>
	<div class="card-tools">
	<?php if($_settings->userdata('type') ==  1): ?>
			<a href="?page=projects/manage_fcprojects" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Add New </a>
			<?php endif; ?>
			...
			<a href="?page=projects/manage_fcprojects" id="create_new" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Add New </a>
			<?php endif; ?>
			<a href="http://192.168.12.24/purchase_order/admin/projects/export.php" id="create_new" class="btn btn-flat btn-success"><span class="fas fa-paper-plane"></span> Export </a>
        ...
        <div class="container-fluid">
			...
			<table id="fcproject" class="table table-hover table-striped">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT pl.*, po.project_name as proname, po.client_id as client_id FROM `project_list` pl inner join `po_list` po on pl.name = po.id order by (`name`) asc ");
							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon py-0" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item view_data" href="?page=projects/view_details&id=<?php echo $row['id'] ?>" data-id = "<?php echo $row['id'] ?>"><span class="fa fa-info text-primary"></span> View</a>
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item edit_data" href="?page=projects/manage_projectfc&id=<?php echo $row['id'] ?>" data-id = "<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> Edit</a>
				                    <div class="dropdown-divider"></div>
									<?php if($_settings->userdata('type') ==  1): ?>
...
$(document).ready(function(){
		...
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Create New Project","projects/manage_fcprojects.php")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-info-circle'></i> Project Details","projects/view_details.php?id="+$(this).attr('data-id'),"")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Edit Project Details","projects/manage_fcprojects.php?id="+$(this).attr('data-id'))
		})
