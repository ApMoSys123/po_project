...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Purchase Order / Letter Of Intent Details": "New Purchase Order" ?> </h3>
	...
	<div class="card-body" id="out_print">
        ...
        <div class="row mb-2">
            ...
            <div class="col-6 row">
                ...
                <dd class="col-md-8">: <?php echo $project_name ?></dd>
                ...
                <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <thead>
                        <tr class="bg-navy disabled" style="">
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Milestone_no</th>
                            ...
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Comments</th>
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Billable</th>
                    ...
                    <tbody>
                        ...
                        while($row = $order_items_qry->fetch_assoc()):
                            $sub_total += $row['po_value'];  
                        ?>
                        <tr class="po-item" data-id="">
                            <td class="align-middle p-0 text-center"><?php echo $row['milestone_no'] ?></td>
                            <td class="align-middle p-1 text-center"><?php echo $row['milestone_name'] ?></td>
                            ...
                            <td class="align-middle p-1 text-center"><?php echo $row['milestone_comments'] ?></td>
                            
                           
                            <td class="align-middle p-1 text-center"><?php echo $row['billable'] ?></td>
                    ...
                    <tfoot>
                        <tr class="bg-lightblue">
                            ...
                            <tr>
                                <th class="p-1 text-right" colspan="9">Tax Inclusive (<?php echo isset($tax_percentage) ? $tax_percentage : 0 ?>%)</th>
                                <th class="p-1 text-right"><?php echo isset($tax_amount) ? number_format($tax_amount) : 0 ?></th>
                            </tr>

                            <tr>
                                <th class="p-1 text-right" colspan="9">Consumed</th>
                                <th class="p-1 text-right" id="consumed"><?php echo number_format($consumed) ?></th>
                            </tr>
                            <tr>
                                <th class="p-1 text-right" colspan="9">Balance</th>
                                <th class="p-1 text-right" id="Balance"><?php echo number_format($balance) ?></th>
                            </tr>
                        ...
                        <div id="accordion" class="my-2">
                            <div class="card bg-modal box-shadow">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style>
                                    <div class="card-body ">
                                        <p class="text-justify"><?php echo isset($businesshead_comments) ? $businesshead_comments : '' ?></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div id="accordion" class="my-2">
                            <div class="card bg-modal box-shadow">
                                ...
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion" style>
                                    <div class="card-body ">
                                        <p class="text-justify"><?php echo isset($businessteam_comments) ? $businessteam_comments : '' ?></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="accordion2" class="my-2">
                            <div class="card bg-modal box-shadow">
                                ...
                                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordion2" style>
                                    <div class="card-body ">
                                        <p class="text-justify"><?php echo isset($accountshead_comments) ? $accountshead_comments : '' ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="accordion3" class="my-2">
                            <div class="card bg-modal box-shadow">
                                ...
                                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordion3" style>
                                    <div class="card-body ">
                                        <p class="text-justify"><?php echo isset($accountsteam_comments) ? $accountsteam_comments : '' ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="accordion4" class="my-2">
                            <div class="card bg-modal box-shadow">
                                ...
                                <div id="collapseEight" class="collapse" aria-labelledby="headingEight" data-parent="#accordion4" style>
                                    <div class="card-body ">
                                        <p class="text-justify"><?php echo isset($director_comments) ? $director_comments : '' ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<table class="d-none" id="item-clone">
	<tr class="po-item" data-id="">
		...
		<td class="align-middle p-0 text-center">
			<input type="number" class="text-center w-100 border-0" step="any" name="milestone_no[]" required/>
		</td>
	
		<td class="align-middle p-1">
			<input type="text" class="text-center w-100 border-0" name="milestone_name[]"  id="milestone_name"  required/>
		</td>
		...
		<td class="align-middle p-1">
			<input type="text" class="text-center w-100 border-0" name="milestone_comments[]" id="milestone_comments" required/>
		</td>
		<td class="align-middle p-1">
			<input type="number" class="text-center w-100 border-0" data-action="sumDebit" name="billable[]" id="billable" required/>
		</td>
	
		<td class="align-middle p-1">
			<input type="number" step="any" class="text-right w-100 border-0"  id="po_value" name="po_value[]" value=""/>
		</td>
