...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><b><u><?php echo isset($id) ? "TNM Purchase Order / Letter Of Intent Details": "New Purchase Order" ?> </u></b></h3>
        <div class="card-tools">
            <button class="btn btn-sm btn-flat btn-success" id="print" type="button"><i class="fa fa-print"></i> Print</button>
            <?php if($_settings->userdata('type') == 1): ?>
		    <a class="btn btn-sm btn-flat btn-primary" href="?page=purchase_orders_tnm/manage_po&id=<?php echo $id ?>">Edit</a>
             <?php endif; ?>
		    <a class="btn btn-sm btn-flat btn-default" href="?page=purchase_orders_tnm">Back</a>
        </div>
	</div>
               ...
               <table class="table table-striped table-bordered" id="item-list">
                    ...
                    <thead>
                        <tr class="bg-navy disabled" style="">
                            ...
                            <th class="bg-navy disabled text-light px-1 py-1 text-center">Monthly Billing</th>
                    ...
                    <tbody>
                        ...
                        while($row = $order_items_qry->fetch_assoc()):
                            $sub_total += $row['per_resourcecount']*$row['resource_count'];  
                        ?>
                        
                        <tr class="po-item" data-id="">
                           
                        <td class="align-middle p-1 text-center"><?php echo $row['resource_count'] ?></td>
                            ...
                            <td class="align-middle p-1 text-right "><?php echo number_format($row['monthly_billing']) ?></td>
                            <td class="align-middle p-1 text-right "><?php echo number_format($row['per_resourcecount']) ?></td>
                    ...
                    <div class="col-6">
                        ...
                        <?php
							switch ($status) {
								...
								// 	break;
                                // case 'Denied':
                                //     echo "<span class='py-0 px-1 btn-flat btn-danger'>Denied</span>";
                                //     break;
								}
							?>	
                    ...
                    <div class="col-6">
                        ...
                        <?php
							switch ($project_type) {
								...
								case 'TNM':
									echo '<span class="badge badge-secondary">TNM</span>';
									break;
								}
							?>	
...
<table class="d-none" id="item-clone">
	<tr class="po-item" data-id="">
		...
		<td class="align-middle p-1">
			<input type="text" class="text-center w-100 border-0" name="milestone_name[]"/>
		</td>
		<td class="align-middle p-1">
		...
		<td class="align-middle p-1">
			<input type="number" step="any" class="text-center w-100 border-0" name="po_value[]" value="0"/>
		</td>
