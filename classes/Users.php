...
Class Users extends DBConnection {
	...
	public function save_users(){
		...
		if(isset($_FILES['img']) && $_FILES['img']['tmp_name'] != ''){
				$fname = 'uploads/'.strtotime(date('y-m-d H:i')).'_'.$_FILES['name'];
				$move = move_uploaded_file($_FILES['img']['tmp_name'],'../'. $fname);
				if($move){
					$data .=" '{$fname}' ";
					if(isset($_SESSION['userdata']) && is_file('../'.$_SESSION['userdata']) && $_SESSION['userdata']['id'] == $id)
						unlink('../'.$_SESSION['userdata']);
				}
		}
		if(empty($id)){
